    ...
    <footer className="mil-relative">
        ...
        <div className="container-fluid">
            ...
            <div className="mil-footer-bottom">
                <p className="mil-light-soft mil-mb-15">© 2024 All Right Recived <Link href='https://brightmedia.tech/'  target="_blank" style={{backgroundColor:"#BCFF00",color:'black'}}> BRIGHT MEDIA</Link></p>
